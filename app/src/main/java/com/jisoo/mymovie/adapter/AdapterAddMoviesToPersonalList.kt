...
import com.jisoo.mymovie.databinding.CardMoviePersonalListBinding
...
class AdapterAddMoviesToPersonalList: ListAdapter<ResultsItem, AdapterAddMoviesToPersonalList.ViewHolder>(COMPARATOR_ADAPTER) {
    ...
    inner class ViewHolder(private val binding: CardMoviePersonalListBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(item: ResultsItem) {
            binding.apply {
                ...
                btnAddPersonalList.setOnClickListener {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = CardMoviePersonalListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
